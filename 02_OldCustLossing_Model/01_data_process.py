...
if __name__=="__main__":
    print('Reading Data ...')
    work_file=r'F:/WorkProjects/Data/WorkDemo(MachineLearning)/02_OldCustLossing_Data/'
    b=odr.origin_data_read(work_file + 'OriginData/',file_type='.csv',encoding_type='utf-8') # 读取文件
    ...
    df1=featrue_data[featrue_data['file_name']=='LZH_LIUSHI_OLD_NEW_20170807.csv']
    del df1['file_name']
    df1.to_csv(work_file + 'ModelData/model_data.csv',index=False)
    df2=featrue_data[featrue_data['file_name']=='LZH_LIUSHI_OLD_NEW_20171207.csv']
    del df2['file_name']
